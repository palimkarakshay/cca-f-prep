...
> Stop here if you haven't taken `full-mock-exams/diagnostic-01.md` yet.
...
**Domain:** 1 — Agentic Architecture & Orchestration → sub-area "Hooks." Also touches Domain 2 (settings.json shape).
...
**Domain:** 1 — Agentic Architecture & Orchestration → sub-area "Bounded loops & session budget."
...
**Domain:** 2 — Claude Code Configuration & Workflows → sub-area "CLAUDE.md as evolving context."
...
**Domain:** 2 — Claude Code Configuration & Workflows → sub-area "Hooks vs. memory vs. CLAUDE.md."
...
**Domain:** 3 — Tool Design & MCP Integration → sub-area "MCP transports."
...
**Domain:** 3 — Tool Design & MCP Integration → sub-area "Tool descriptions and selection."
...
**Domain:** 4 — Prompt Engineering & Structured Output → sub-area "Structured output / tool use as schema."
...
**Domain:** 4 — Prompt Engineering & Structured Output → sub-area "Few-shot prompting & message structure."
...
**Domain:** 5 — Context Management & Reliability → sub-area "Prompt caching."
...
| 5–6 | Sequence training by exam weight: D1 (27%) → D2 (20%) → D4 (20%) → D3 (18%) → D5 (15%). Spend longer on D1. |
