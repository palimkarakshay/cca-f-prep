...
/* ------------------------------------------------------------------
   ...
   Copied verbatim from docs/curriculum.js. Do not edit content here
   without updating docs/curriculum.js (or deleting docs/ once the new
   shell is the canonical surface).
  ...
  "sections": [
    {
      ...
      "concepts": [
            ...
            "questions": [
              {
                ...
                "options": {
                  "A": "Project files are loaded into context, not retrieved by similarity — so all of them compete for attention.",
                  "B": "The model's context window is too small to hold the embeddings index.",
                ...
                "correct": "A",
                "explanations": {
                  "A": "Right. Project files are in-context file storage, not RAG. Every chat loads attached files as raw text up to the context limit; when relevance pressure goes up, retrieval-by-similarity is what fixes it, not 'more files'.",
                  "B": "Wrong axis. There is no embeddings index in a Claude.ai Project — the misconception this option encodes is the question's whole trap.",
              ...
              },
              {
                ...
                "options": {
                  "A": "RAG for short documents, Project for long ones.",
                  "B": "Always Project; RAG is a legacy pattern for older Claude versions.",
                  "C": "Project: small corpus that all needs to be considered every chat. RAG: corpus too big to fit in context, or only the relevant slice should be retrieved.",
                  "D": "They are interchangeable; the choice is purely a cost optimization."
                },
                "correct": "C",
                "explanations": {
                  "A": "Document length isn't the deciding factor. Corpus size and the every-chat-vs-on-demand question are.",
                  "B": "RAG is the standard pattern for any non-trivial corpus. Newer Claude versions don't change that.",
                  "C": "Right. Project = small, durable, every-chat context. RAG = scale-out via retrieval. The deciding axis is whether all the content needs to be present every chat.",
        ...
        },
        {
          "id": "b1-2",
          "code": "B1.2",
          "title": "Product-tier vs API-level limit",
          "bloom": "A",
          "lesson": {
            "status": "ready",
            "paragraphs": [
            ...
            "questions": [
              ...
              },
              {
                ...
                "options": {
                  ...
                  "B": "Only if the API key was issued from the same Claude.ai account.",
                  "C": "No — daily message caps are a Claude.ai product-tier feature; the API uses rate limits and credit budgets instead.",
                ...
                "explanations": {
                  ...
                  "B": "Account-key linkage doesn't import the tier cap into the API.",
                  "C": "Right. The API has per-minute and per-token rate limits and a credit budget — there is no 'you've used your 50 messages today' counter.",
              ...
              },
              {
                ...
                "options": {
                  ...
                  "B": "The shape of a tool-use loop returned via stop_reason.",
                  "C": "The per-token billing rate for input vs output tokens.",
                  "D": "Whether the model dropdown lets the user pick the latest Sonnet vs forcing them onto Haiku."
                },
                "correct": "D",
                "explanations": {
                  "A": "Model window is set by the model itself — same on Claude.ai and the API.",
                  "B": "stop_reason and the tool-use loop are protocol-level, not product-tier.",
                  "C": "Billing rates are platform-side and apply uniformly to a given model.",
                  "D": "Right. Model selection (which models the dropdown exposes) is a subscription-tier feature on Claude.ai. The API serves any model your account is entitled to without a UI gate."
                },
        ...
        },
        {
          "id": "b1-3",
          "code": "B1.3",
          "title": "Artifact vs inline message",
          "bloom": "E",
          "lesson": {
            "status": "ready",
            "paragraphs": [
            ...
            "questions": [
              {
                ...
                "options": {
                  ...
                  "B": "Inline messages are hard-capped at 1,000 words; Artifacts have no such limit.",
                  "C": "Inlining the brief replays its full text in chat history on every turn; an Artifact lives in a separate pane and is referenced, not replayed.",
                  "D": "Artifacts get a separate review pass from a smaller model."
                },
                "correct": "C",
                "explanations": {
                  "A": "Per-call token cost is identical. The win is structural.",
                  "B": "Fabricated limit. There is no 1,000-word inline cap.",
                  "C": "Right. The chat thread carries every prior message into context. A 3,500-word inline draft, multiplied by 5–6 iteration turns, is multi-tens-of-thousands of tokens of duplicated content. The Artifact pattern decouples the deliverable from the conversation.",
              ...
              },
              {
                ...
                "options": {
                  ...
                  "B": "Artifacts can't be edited once created, so short replies couldn't be corrected.",
                  "C": "The Artifact API is rate-limited and would throttle a normal chat.",
                  "D": "Artifacts add UI ceremony and break conversational flow; their value is structural for long iterable output, not aesthetic for short replies."
                },
                "correct": "D",
                "explanations": {
                  "A": "Fabricated retention rule.",
                  "B": "False. Artifacts are explicitly editable — that's part of the value for iterable output.",
                  "C": "Fabricated rate limit.",
                  "D": "Right. The Artifact construct exists to decouple long deliverables from the chat thread. A two-sentence reply gains nothing from that decoupling and loses conversational fluidity."
                },
              ...
              },
              {
                ...
                "options": {
                  "A": "A one-sentence answer to a yes/no question about how a feature works.",
                  "B": "A 200-line Python script the user will run, edit, and re-paste back for review.",
                ...
                "correct": "A",
                "explanations": {
                  "A": "Right. A single sentence is conversation, not deliverable. Wrapping it adds friction and breaks flow.",
                  "B": "Long, iterable, copy-out — textbook Artifact case.",
        ...
        },
        {
          "id": "b1-4",
          "code": "B1.4",
          "title": "Context cost of N file uploads",
          "bloom": "A",
          "lesson": {
            "status": "ready",
            "paragraphs": [
            ...
            "questions": [
              {
                ...
                "explanations": {
                  ...
                  "B": "Fabricated. There is no separate 'attention budget' cap.",
                  "C": "Fabricated mechanism. There is no tier-based cache eviction of conversation turns.",
                  "D": "Right. ~200 KB of files in the system context every turn leaves the conversation a much smaller working budget. Earlier turns drop because the window is genuinely tighter, not because anything is being summarized."
                },
              ...
              },
              {
                ...
                "options": {
                  "A": "No — adding files raises the per-turn context cost and increases attention competition. The fix is usually to remove files or move to retrieval, not add more.",
                  "B": "Yes, but only if the new PDFs are smaller than the existing ones, to stay under the file-count limit.",
                  "C": "Yes — more reference material gives Claude more grounding to answer correctly.",
                  "D": "No — Project files are write-once; the originals would have to be re-uploaded together."
                },
                "correct": "A",
                "explanations": {
                  "A": "Right. The corrective intervention when answer quality drops on a heavy Project is to reduce the file load or switch the access pattern (retrieval), not to add more.",
                  "B": "File-count is not the binding constraint here; aggregate token cost and attention quality are.",
                  "C": "This is the canonical failure mode the lesson names. More files = more context cost + more attention competition, not better grounding.",
        ...
        "questions": [
          {
            ...
            "options": {
              "A": "Each chat would load all 200 docs into context, exceeding the window and degrading attention even where it fits.",
              "B": "Projects only support up to 50 files; this hits the limit.",
            ...
            "correct": "A",
            "explanations": {
              "A": "Right. Projects are in-context file storage. 200 docs = 200 docs of system context every chat. Quality degrades long before the hard window limit; relevance pressure makes retrieval the right tool.",
              "B": "Wrong axis. Even if the file-count limit weren't an issue, the underlying problem (no retrieval, all-in-context) is the real reason.",
          ...
          },
          {
            ...
            "options": {
              ...
              "B": "Inline text is hard-capped at 1 000 words; Artifacts have no such limit.",
              "C": "Artifacts isolate the long output from conversational context, so iteration doesn't bloat the chat history, and the Artifact can be re-rendered/edited directly.",
            ...
            "explanations": {
              ...
              "B": "Fabricated limit. There is no 1 000-word inline cap.",
              "C": "Right. The point of the Artifact construct is *separation*: the long deliverable lives outside the chat thread and can be iterated without polluting context or replaying the entire doc on every turn.",
          ...
          },
          {
            ...
            "options": {
              ...
              "B": "Cost depends on the subscription tier; pro users pay no context cost for Project files.",
              "C": "Cost is paid only on the first message; subsequent messages reuse a cached representation at no context cost.",
              "D": "~360 KB of context is consumed by Project files on every chat, leaving the rest of the window for the conversation and answer."
            },
            "correct": "D",
            "explanations": {
              "A": "There is no separate budget. One window, shared.",
              "B": "Subscription doesn't change the per-message context math.",
              "C": "There is no first-turn-only caching of Project files at this layer; they're re-included every turn.",
              "D": "Right. Project files load into the same context window as the rest of the prompt. 12 × 30 KB ≈ 360 KB consumed every chat. That's the budget the conversation and answer share with the corpus."
            },
      ...
      "concepts": [
        {
          "id": "b2-1",
          "code": "B2.1",
          "title": "Classify failure into a 4D",
          "bloom": "An",
          "lesson": {
            "status": "ready",
            "paragraphs": [
            ...
            "questions": [
              ...
              },
              {
                ...
                "options": {
                  ...
                  "B": "Discernment — the user needs to read each output more carefully.",
                  "C": "Description — the prompt didn't pin down the output shape; specifying the format (and ideally enforcing via tool-use schema) is the fix.",
                ...
                "explanations": {
                  ...
                  "B": "Reading each output catches mistakes but doesn't fix the source.",
                  "C": "Right. Inconsistent format = the output shape wasn't specified clearly. Re-describe (and ideally use a tool-schema to enforce). Description, not switching models.",
              ...
              },
              {
                ...
                "options": {
                  ...
                  "C": "Diligence — the team failed to consult an attorney.",
                  "D": "Discernment — the team accepted plausible output without verifying citations before publishing."
                },
                "correct": "D",
                "explanations": {
                  ...
                  "C": "Diligence covers oversight policy; the immediate miss was failing to verify.",
                  "D": "Right. The output landed in a public brief without anyone checking the citations. Discernment is the verification step that didn't happen."
                },
            ...
            "questions": [
              {
                ...
                "options": {
                  ...
                  "B": "Add temperature=0 and ask for chain-of-thought to make reasoning more careful.",
                  "C": "Recognize this as mis-delegation; have the LLM emit code/SQL and run the aggregation deterministically, returning results back.",
                ...
                "explanations": {
                  ...
                  "B": "Temperature/CoT tweaks are description-level. The plateau says description isn't the lever.",
                  "C": "Right. Aggregations over hundreds of thousands of rows belong in deterministic code. Use the LLM to choose the operation and read the result; run the math in SQL or a script.",
              ...
              },
              {
                ...
                "options": {
                  ...
                  "C": "Reformatting a paragraph from prose to bullet points.",
                  "D": "Returning today's stock price for a ticker as of 10 minutes ago."
                },
                "correct": "D",
                "explanations": {
                  "A": "Summarisation is a strong-fit LLM task.",
                  "B": "Creative generation is a strong-fit LLM task.",
                  "C": "Reformatting is a textbook strong-fit LLM task.",
                  "D": "Right. Real-time market data is outside the model's training cutoff and isn't recoverable by better prompting. Without a price-feed tool, the request is structurally undelegatable."
                },
              ...
              },
              {
                ...
                "options": {
                  "A": "Writing rows to the customer database directly from the LLM's response with no validation layer.",
                  "B": "Extracting entities from free-text input.",
                  "C": "Drafting the personalised email body.",
                  "D": "Choosing the email's subject line based on extracted entities."
                },
                "correct": "A",
                "explanations": {
                  "A": "Right. Direct, unvalidated DB writes from LLM output is the high-stakes irreversible class — bad delegation. The LLM should propose; a deterministic validator should write.",
                  "B": "Extraction from free text is a strong-fit LLM task.",
        ...
        },
        {
          "id": "b2-3",
          "code": "B2.3",
          "title": "Write a structured description",
          "bloom": "A",
          "lesson": {
            "status": "ready",
            "paragraphs": [
            ...
            "questions": [
              {
                ...
                "options": {
                  ...
                  "B": "Delegation to a smaller model so the output is more deterministic.",
                  "C": "A larger context window so the transcript fits comfortably.",
                  "D": "Explicit format specification (e.g., 'markdown bullet list, format: `- [Speaker]: action`') ideally with one worked example."
                },
                "correct": "D",
                "explanations": {
                  "A": "Higher temperature increases variance — opposite of what's wanted.",
                  "B": "Switching models doesn't add format specification to the prompt.",
                  "C": "Window size doesn't address output-shape variance.",
                  "D": "Right. The output shape isn't specified, so the model varies. Naming the format and showing one worked example is the canonical fix."
                },
              ...
              },
              {
                ...
                "options": {
                  "A": "'Do not invent root causes; if the ticket doesn't state one, write `not stated` for that field.'",
                  "B": "'Use your best judgment.'",
                  "C": "'Be helpful and accurate.'",
                  "D": "'Try to be concise.'"
                },
                "correct": "A",
                "explanations": {
                  "A": "Right. Names a specific failure mode (invented root cause), names the contract for missing data (`not stated`). Checkable, falsifiable, action-changing.",
                  "B": "Anti-constraint — increases variance.",
                  "C": "Not actionable. The model already aims to be helpful and accurate.",
        ...
        },
        {
          "id": "b2-4",
          "code": "B2.4",
          "title": "Run description ↔ discernment loop",
          "bloom": "A",
          "lesson": {
            "status": "ready",
            "paragraphs": [
            ...
            "questions": [
              {
                ...
                "correct": "A",
                "explanations": {
                  "A": "Right. Same prompt → different sample. Picking the best one doesn't change anything for next time. Running the Description ↔ Discernment loop adds the missing spec to the prompt so the next run is durably better.",
                  "B": "Cost is true but not the structural critique.",
                  "C": "Same model.",
                  "D": "Fabricated."
                },
              ...
              },
              {
                ...
                "options": {
                  ...
                  "B": "Wrap the response in retry logic with regex validation.",
                  "C": "Add an explicit format spec (and ideally one worked example) to the prompt and re-run.",
                  "D": "Move the task to a more powerful model."
                },
                "correct": "C",
                "explanations": {
                  "A": "Lowering temperature reduces variance but doesn't add format specification.",
                  "B": "Retry/validation is a workaround for not iterating the description.",
                  "C": "Right. Discernment named the gap (format inconsistency); the loop says re-describe with explicit format. Most direct fix.",
        ...
        },
        {
          "id": "b2-5",
          "code": "B2.5",
          "title": "Name the diligence concern",
          "bloom": "E",
          "lesson": {
            "status": "ready",
            "paragraphs": [
            ...
            "questions": [
              ...
              },
              {
                ...
                "options": {
                  ...
                  "B": "Token cost on the backend model.",
                  "C": "Misuse risk — adversarial inputs (prompt injection, jailbreak) attempting to abuse refunds or access accounts; also transparency that users are talking to an AI.",
                ...
                "explanations": {
                  ...
                  "B": "Cost-side.",
                  "C": "Right. Tools that effect changes are exactly the surface adversarial inputs target. Misuse risk dominates.",
                  "D": "UX, not diligence."
                },
              ...
              },
              {
                ...
                "options": {
                  ...
                  "B": "Diligence is the model vendor's responsibility, not the deploying team's.",
                  "C": "Diligence applies only to medical and legal applications.",
                  "D": "Diligence is a design-time concern (oversight, bias, misuse, ownership, transparency); the specific concern depends on the deployment shape."
                },
                "correct": "D",
                "explanations": {
                  "A": "Diligence is design/process — not a prompt feature.",
                  "B": "The deploying team owns the outcome.",
                  "C": "Applies broadly; not domain-restricted.",
                  "D": "Right. Design-time and shape-specific. The exam rewards naming the specific concern that matches the scenario."
                },
        ...
        "questions": [
          {
            ...
            "options": {
              ...
              "B": "Discernment — the team needs to spot-check more carefully.",
              "C": "Delegation — exact arithmetic at scale is structurally a bad fit; have the LLM emit code and run the math deterministically.",
            ...
            "explanations": {
              ...
              "B": "Verification catches errors but doesn't make the system reliable.",
              "C": "Right. The Description ↔ Discernment loop's plateau is the cue to re-classify as Delegation. Exact totals belong in code; the LLM proposes, the code computes.",
          ...
          },
          {
            ...
            "options": {
              ...
              "D": "Specify the exact format and include one worked example of input → output."
            },
            "correct": "D",
            "explanations": {
              "A": "Not actionable.",
              "B": "Bigger model masks the issue without fixing it.",
              "C": "Temperature reduces variance but not the underlying ambiguity.",
              "D": "Right. Format unspecified = model fills with priors that vary. Naming the exact format and showing one worked example is the canonical Description fix."
            },
          ...
          },
          {
            ...
            "options": {
              "A": "Discernment — output was trusted without verification; insert a verification step before publication.",
              ...
              "C": "Description — re-prompt asking the model to flag uncertainty.",
              "D": "Diligence — train the team better."
            },
            "correct": "A",
            "explanations": {
              "A": "Right. The output landed in a brief without verification. Discernment is the verification step that should have happened.",
              "B": "True upstream, but the question asks for the operational miss.",
              "C": "Self-flagging by the model is unreliable and not the operational miss.",
      ...
      "concepts": [
        {
          "id": "b3-1",
          "code": "B3.1",
          "title": "Place instruction in system vs user",
          "bloom": "E",
          "lesson": {
            "status": "ready",
            "paragraphs": [
            ...
            "questions": [
              {
                ...
                "options": {
                  ...
                  "B": "Inject it into the assistant's first reply via prefill.",
                  "C": "Send it as a separate, third role between system and user.",
                  "D": "Add it to the system prompt — it is a durable, role-defining guardrail that should apply on every call regardless of the user's input."
                },
                "correct": "D",
                "explanations": {
                  ...
                  "B": "Prefill steers a single response, doesn't establish a persistent rule.",
                  "C": "There is no third role.",
                  "D": "Right. Durable, role-defining rules belong in `system`. Same on every call, more authoritative than user content."
                },
              ...
              },
              {
                ...
                "options": {
                  "A": "Today's date (`2026-05-02`), inserted on every call from a server-side timestamp.",
                  "B": "A 3,000-token product reference doc the agent consults on every call.",
                  "C": "A persistent role: 'You are a senior compiler engineer.'",
                  "D": "A guardrail: 'Never run shell commands without user confirmation.'"
                },
                "correct": "A",
                "explanations": {
                  "A": "Right. Volatile per-request data in `system` busts caching (system prefix changes daily) and pollutes the privileged layer. Inject into the user message as a variable instead.",
                  "B": "Stable reference doc + every-call use = canonical system content.",
        ...
        },
        {
          "id": "b3-2",
          "code": "B3.2",
          "title": "Few-shots as alternating turns",
          "bloom": "A",
          "lesson": {
            "status": "ready",
            "paragraphs": [
            ...
            "questions": [
              {
                ...
                "options": {
                  "A": "Use alternating user/assistant turns for the examples; send the actual input as the final user turn.",
                  "B": "Move all examples into the system prompt as a long bulleted list.",
                ...
                "correct": "A",
                "explanations": {
                  "A": "Right. Claude is trained on conversation. Few-shots as user/assistant turn pairs match that distribution; consistency improves because the model sees the input→output shape demonstrated in its native form.",
                  "B": "Better than user-message bullets, but still inline. Doesn't get the conversational-pattern advantage.",
              ...
              },
              {
                ...
                "options": {
                  ...
                  "B": "Translating a single sentence into French.",
                  "C": "Classifying support tickets into one of 10 categories *and* emitting a structured rationale field.",
                  "D": "Echoing the user's input back unchanged."
                },
                "correct": "C",
                "explanations": {
                  "A": "Open creative single-string output benefits little — small structure to imitate.",
                  "B": "Single-sentence translation is trivially structured.",
                  "C": "Right. Multi-class classification with structured rationale has non-trivial output shape. Demonstrating the input→output transform conversationally pays off most.",
        ...
        },
        {
          "id": "b3-3",
          "code": "B3.3",
          "title": "Trace tool-use loop / stop_reason",
          "bloom": "An",
          "lesson": {
            "status": "ready",
            "paragraphs": [
            ...
            "questions": [
              ...
              },
              {
                ...
                "options": {
                  ...
                  "B": "Reject the response; multiple tool_use blocks in one turn is undefined behavior.",
                  "C": "Run both tools (often in parallel) and return *both* `tool_result` blocks in a single user message, each referencing the matching tool_use_id.",
                ...
                "explanations": {
                  ...
                  "B": "Parallel tool use is supported and standard.",
                  "C": "Right. Parallel tool use returns multiple tool_result blocks in one user turn, each matched by tool_use_id. The API supports this and the model expects it.",
              ...
              },
              {
                ...
                "options": {
                  ...
                  "B": "Re-issue the original user message and hope the model picks a different tool.",
                  "C": "Send no follow-up; the loop will time out and the model will retry on its own.",
                  "D": "Return a `tool_result` block with `is_error: true` and the error message in `content`; let the model decide whether to retry, try a different tool, or apologise."
                },
                "correct": "D",
                "explanations": {
                  "A": "Exceptions don't cross the API boundary; the model never sees them.",
                  "B": "Re-issuing loses the tool-use context and won't reliably change the model's choice.",
                  "C": "Loops don't auto-time-out; you'll just hang.",
                  "D": "Right. Errors are first-class in the tool-use loop. is_error: true tool_results give the model the information to recover (retry, alternate tool, graceful failure)."
                },
        ...
        },
        {
          "id": "b3-4",
          "code": "B3.4",
          "title": "Place cache_control marker",
          "bloom": "E",
          "lesson": {
            "status": "ready",
            "paragraphs": [
            ...
            "questions": [
              {
                ...
                "options": {
                  ...
                  "B": "Switch from Sonnet to Haiku.",
                  "C": "Add cache_control to the static reference-docs portion of the system prompt.",
                  "D": "Batch 10 user messages per call."
                },
                "correct": "C",
                "explanations": {
                  "A": "Truncation loses information; you'd ship a worse system prompt to save dollars.",
                  "B": "Haiku trades quality for cost; doesn't address the underlying inefficiency.",
                  "C": "Right. Static prefix + 500 calls/day is the exact shape prompt caching is built for. Cache reads are ~10% of the price of cache writes. With a 30k-token reused prefix, this is the largest available lever.",
              ...
              },
              {
                ...
                "options": {
                  ...
                  "B": "Cache hit rate metrics lag by 24 hours; they should re-check tomorrow.",
                  "C": "The model doesn't cache system prompts that contain dates.",
                  "D": "Today's date sits above the marker, so the cached prefix's bytes change daily; cache is rebuilt every day."
                },
                "correct": "D",
                "explanations": {
                  ...
                  "D": "Right. The cache requires exact-byte match on the prefix above the marker. Letting dynamic content slip above the marker changes the cache key every day; the cache is recreated every day with no reuse."
                },
              ...
              },
              {
                ...
                "correct": "A",
                "explanations": {
                  "A": "Right. The marker sits at the boundary between stable (role + manual) and dynamic (date). The cache covers role + manual; date and question stay fresh.",
                  "B": "Caches nothing useful — the role definition is small.",
        ...
        },
        {
          "id": "b3-5",
          "code": "B3.5",
          "title": "Tool-schema vs prompt-only structured output",
          "bloom": "E",
          "lesson": {
            "status": "ready",
            "paragraphs": [
            ...
            "questions": [
              {
                ...
                "options": {
                  ...
                  "B": "Increase temperature so the model takes more care.",
                  "C": "Wrap the response in <json> XML tags and parse the inner content.",
                  "D": "Use the API's structured-output / tool-use mode with a JSON schema for the records."
                },
                "correct": "D",
                "explanations": {
                  "A": "Soft constraint. The model will still violate it ~3% of the time, exactly the rate the question describes.",
                  "B": "Higher temperature increases variance, not reliability.",
                  "C": "XML tags don't constrain the JSON inside. Same trailing-comma bug recurs.",
                  "D": "Right. Structured output / tool use with a schema uses constrained decoding — the model literally cannot emit tokens that violate the schema for those fields. Platform-level guarantee."
                },
              ...
              },
              {
                ...
                "options": {
                  "A": "A chat assistant explaining a concept conversationally to a human user.",
                  "B": "Returning a JSON list of search results to a frontend renderer.",
                  "C": "Extracting {customer_id, amount, date} into a billing pipeline.",
                  "D": "Producing a CSV-shaped string ingested by an analytics job."
                },
                "correct": "A",
                "explanations": {
                  "A": "Right. Conversational human-readable output gains nothing from schema constraint; the consumer is a person, not a parser.",
                  "B": "Frontend renderer parses JSON — high benefit.",
                  "C": "Pipeline parsing — high benefit from schema constraint.",
        ...
        },
        {
          "id": "b3-6",
          "code": "B3.6",
          "title": "Detect system-field leak",
          "bloom": "An",
          "lesson": {
            "status": "ready",
            "paragraphs": [
            ...
            "questions": [
              {
                ...
                "options": {
                  "A": "Today's date and user ID are in the system prefix; the prefix's bytes change per call so the cache key never matches a prior call.",
                  "B": "Cache TTL is too short for the call frequency.",
                ...
                "correct": "A",
                "explanations": {
                  "A": "Right. System-field leak. Volatile data in the prefix → exact bytes differ per call → cache key differs → no hits. Move date and user ID to the user message.",
                  "B": "TTL doesn't help when each call has a different prefix.",
                  "C": "Fabricated rule.",
              ...
              },
              {
                ...
                "explanations": {
                  ...
                  "B": "Removes useful information from the prompt; doesn't address the architectural mistake.",
                  "C": "Right. The user field is the correct home for per-request data. Moving the date there restores byte-stability of the system prefix and re-enables caching.",
      ...
      "sectionTest": {
        ...
        "questions": [
          ...
          },
          {
            ...
            "options": {
              "A": "The model needs more max_tokens to fit the full answer.",
              "B": "Temperature is too high; lower it to reduce placeholder text.",
              "C": "The integration treats `stop_reason: tool_use` as the final response and exits the loop instead of executing the tool and returning a tool_result.",
              "D": "A retry loop is firing too aggressively."
            },
            "correct": "C",
            "explanations": {
              "A": "max_tokens controls per-message length, not loop continuation.",
              "B": "Temperature doesn't change loop semantics.",
              "C": "Right. The canonical tool-loop bug. tool_use is a request to run a tool, not the final answer. Continue the loop with a tool_result; loop ends only on end_turn.",
          ...
          },
          {
            ...
            "options": {
              ...
              "B": "Add retry logic and lower the temperature.",
              "C": "Increase context window and switch to a smaller model.",
              "D": "Restructure the few-shots as alternating user/assistant turns AND switch to a tool-schema for the JSON output (constrained decoding eliminates structural drift)."
            },
            "correct": "D",
            "explanations": {
              "A": "Both are weak signals; structural changes are available.",
              "B": "Retry/temperature are workarounds for the structural fix.",
              "C": "Doesn't address the structural issues.",
              "D": "Right. Two stacked structural fixes: (B3.2) alternating turns matches the training distribution for cleaner imitation; (B3.5) tool-schema constrains decoding so the JSON envelope cannot drift. Both are platform-level guarantees rather than prompt requests."
            },
          ...
          },
          {
            ...
            "options": {
              "A": "In the system prompt, because system content is privileged: it outranks user content in conflicts and applies on every call without re-sending.",
              "B": "In the user message, since it relates to handling user questions.",
              "C": "In a tool description, so the model checks before calling tools.",
              "D": "In the assistant prefill of every response."
            },
            "correct": "A",
            "explanations": {
              "A": "Right. Persistent role-defining rules belong in `system`. The privilege of `system` over `user` is exactly what allows guardrails to survive adversarial user input.",
              "B": "User-message rules can be contradicted by subsequent user content. The privilege ordering is what makes guardrails durable.",
      ...
      "concepts": [
        {
          "id": "b4-1",
          "code": "B4.1",
          "title": "Classify tool / resource / prompt",
          "bloom": "An",
          "lesson": {
            "status": "ready",
            "paragraphs": [
            ...
            "questions": [
              {
                ...
                "explanations": {
                  ...
                  "B": "Prompts are templates with slots, not data containers. Users would have to pick something for which there's no choice to make.",
                  "C": "Right. Resources are read-only data references the user/app attaches. The handbook is data, not an action.",
              ...
              },
              {
                ...
                "options": {
                  ...
                  "C": "A list of company branding colors as a JSON document.",
                  "D": "A `create_jira_ticket` operation the model decides to call mid-conversation when the user reports a bug."
                },
                "correct": "D",
                "explanations": {
                  "A": "Read-only content = resource.",
                  "B": "User-invoked template = prompt.",
                  "C": "Read-only data = resource.",
                  "D": "Right. Model-invoked, side-effecting operation = tool."
                },
              ...
              },
              {
                ...
                "correct": "A",
                "explanations": {
                  "A": "Right. Reusable, user-invoked templated workflow with slots = prompt. One-click discoverability is the prompt menu.",
                  "B": "PRs are data; the recurring *workflow* (write release notes from them) is what's being templated.",
                  "C": "The model can't reliably guess when the user wants weekly notes; user-invoked is the right shape.",
            ...
            "questions": [
              {
                ...
                "options": {
                  ...
                  "B": "gRPC, for strongly-typed schemas.",
                  "C": "WebSockets, for full-duplex streaming.",
                  "D": "stdio, because the server runs on the same machine and its lifecycle is bound to the Claude Code process."
                },
                "correct": "D",
                "explanations": {
                  "A": "Streamable HTTP is for remote or multi-user MCP servers. Single dev, same machine? Overkill.",
                  "B": "gRPC is not a current MCP transport.",
                  "C": "WebSockets is not a current MCP transport.",
                  "D": "Right. stdio is the canonical local-machine transport. Claude Code spawns the server as a subprocess; lifecycle is bound to the Claude process; no port management; no auth surface."
                },
              ...
              },
              {
                ...
                "options": {
                  "A": "Streamable HTTP — multi-user, remote, auth at transport, lives independently of any single client.",
                  "B": "stdio — each developer's Claude Code spawns its own subprocess of the server.",
                ...
                "correct": "A",
                "explanations": {
                  "A": "Right. Multi-user / remote / shared = Streamable HTTP. Auth lives at the transport layer; the server outlives any client.",
                  "B": "Each dev would spawn a fresh local copy. Doesn't share state, can't centralise updates, and can't enforce auth at transport.",
        ...
        },
        {
          "id": "b4-3",
          "code": "B4.3",
          "title": "Reject non-MCP transports",
          "bloom": "R",
          "lesson": {
            "status": "ready",
            "paragraphs": [
            ...
            "questions": [
              {
                ...
                "correct": "A",
                "explanations": {
                  "A": "Right. WebSockets is not an MCP transport. The closed list is stdio + Streamable HTTP.",
                  "B": "Valid — current name for the remote/multi-user transport.",
                  "C": "Valid — local single-user transport.",
              ...
              },
              {
                ...
                "options": {
                  ...
                  "B": "Reject — Streamable HTTP already supports streaming (via Server-Sent Events) and is the spec-defined remote transport. WebSockets is not an MCP transport.",
                  "C": "Reject and pick gRPC for typed streaming.",
                  "D": "Approve, but only on internal networks."
                },
                "correct": "B",
                "explanations": {
                  "A": "Off-spec. WebSockets isn't MCP.",
                  "B": "Right. Streamable HTTP already streams. 'I want streaming' is not a reason to leave the spec.",
                  "C": "gRPC isn't MCP either; same problem.",
        ...
        },
        {
          "id": "b4-4",
          "code": "B4.4",
          "title": "Diagnose wrong-tool-pick to description",
          "bloom": "An",
          "lesson": {
            "status": "ready",
            "paragraphs": [
            ...
            "questions": [
              ...
              },
              {
                ...
                "options": {
                  ...
                  "B": "The version number of the underlying API.",
                  "C": "The 'does NOT handle' boundary that distinguishes it from neighbouring tools.",
                  "D": "The author's name and contact info."
                },
                "correct": "C",
                "explanations": {
                  "A": "Casing is cosmetic.",
                  "B": "Versioning is metadata; not the selection signal.",
                  "C": "Right. Tools live in a list; the model has to differentiate them. The 'does NOT handle' clause is what makes the boundary explicit and most often missing.",
              ...
              },
              {
                ...
                "options": {
                  ...
                  "C": "Removing a redundant tool that overlaps with another.",
                  "D": "Renaming the tools to longer, more descriptive names while leaving the descriptions vague."
                },
                "correct": "D",
                "explanations": {
                  "A": "Most effective fix.",
                  "B": "Effective — adds the when-to-use clause that's often missing.",
                  "C": "Removing redundant tools is a legitimate (less common) fix when descriptions can't differentiate.",
                  "D": "Right. Renaming alone leaves the model with the same selection signal (the description). Names aren't the lever."
                },
        ...
        },
        {
          "id": "b4-5",
          "code": "B4.5",
          "title": "Server-per-capability vs monolith",
          "bloom": "E",
          "lesson": {
            "status": "ready",
            "paragraphs": [
            ...
            "questions": [
              {
                ...
                "options": {
                  ...
                  "B": "One server per environment (dev, staging, prod), each bundling all four integrations.",
                  "C": "Four separate servers (git-mcp, jira-mcp, postgres-mcp, s3-mcp) the client connects to concurrently.",
                ...
                "explanations": {
                  ...
                  "B": "Environment-bundled monolith multiplies the antipattern by environment count.",
                  "C": "Right. Server-per-capability is the canonical MCP design. Each server is focused, independently versioned, and the client composes them.",
              ...
              },
              {
                ...
                "options": {
                  ...
                  "D": "Split the monolith into several capability-focused servers; each server's tool list is small enough for the model to differentiate cleanly."
                },
                "correct": "D",
                "explanations": {
                  "A": "Doesn't address the structural cause.",
                  "B": "Bigger model can mask the issue but doesn't fix the structural cause.",
                  "C": "Bias without information; weaker than splitting.",
                  "D": "Right. Tool-list bloat reduces selection accuracy. Splitting into per-capability servers gives each small focused tool list and resolves the cause."
                },
              ...
              },
              {
                ...
                "options": {
                  "A": "Independent versioning, smaller blast radius for failures, finer-grained auth, and (above ~10 tools) better model selection accuracy.",
                  "B": "It will run faster on multi-core hosts.",
                  "C": "MCP requires a tool-count cap of 12 per server.",
                  "D": "Splitting reduces the per-token cost of tool descriptions."
                },
                "correct": "A",
                "explanations": {
                  "A": "Right. The structural wins are versioning, blast radius, auth granularity, and selection accuracy. All of these compound as the server grows.",
                  "B": "Performance argument is real but secondary.",
                  "C": "Fabricated cap.",
        ...
        },
        {
          "id": "b4-6",
          "code": "B4.6",
          "title": "Auth at transport, not in tool input",
          "bloom": "A",
          "lesson": {
            "status": "ready",
            "paragraphs": [
            ...
            "questions": [
              {
                ...
                "options": {
                  ...
                  "B": "The tool should accept credentials but encrypt them client-side first.",
                  "C": "The tool would work but should rename `api_key` to `bearer_token` for consistency.",
                  "D": "Credentials belong at the transport layer (OAuth, headers, parent-process identity). Putting api_key in the tool input leaks it into the model's context, conversation history, logs, and traces."
                },
                "correct": "D",
                "explanations": {
                  "A": "Tool-level auth is the wrong layer. The model sees tool inputs.",
                  "B": "Client-side encryption doesn't change the fact the model sees the field.",
                  "C": "Renaming doesn't fix the layer error.",
                  "D": "Right. The model reads tool inputs. Auth in the schema means credentials become prompt content — log risk, trace risk, replay risk. Auth belongs at transport."
                },
              ...
              },
              {
                ...
                "options": {
                  "A": "The parent process (the MCP client) owns identity; the server runs in that user's process context, no separate auth surface needed.",
                  "B": "Each tool input must carry a `user_id` field.",
                ...
                "correct": "A",
                "explanations": {
                  "A": "Right. stdio servers run as a child of the client; the client's user owns the process. Identity is implicit and inherited from the parent. No separate auth surface — that's part of why stdio is operationally simple.",
                  "B": "Identity in tool input is the antipattern.",
              ...
              },
              {
                ...
                "explanations": {
                  ...
                  "B": "Right. A bearer_token in the tool input means the model reads, reasons about, and generates with the credential. Should be at transport instead.",
                  "C": "Operation parameter — fine.",
        ...
        "questions": [
          {
            ...
            "options": {
              "A": "(a) resource, (b) tool, (c) prompt, (d) resource.",
              "B": "All four as tools.",
            ...
            "correct": "A",
            "explanations": {
              "A": "Right. Static data the model consumes = resource. Model-invoked operation = tool. User-picked templated workflow = prompt. Static reference table = resource.",
              "B": "Tool-everything bloats the tool list and miscategorises data and templates.",
          ...
          },
          {
            ...
            "options": {
              ...
              "B": "Mark `api_key` as `secret: true` in the schema annotation.",
              "C": "Encrypt `api_key` client-side before sending.",
              "D": "Move authentication to the transport layer (OAuth or headers for HTTP; parent process for stdio); the tool input should carry operation parameters only."
            },
            "correct": "D",
            "explanations": {
              "A": "Renaming doesn't change the layer error.",
              "B": "A `secret: true` annotation is fabricated and wouldn't fix the layer error anyway.",
              "C": "Client-side encryption doesn't change the fact the model sees the field.",
              "D": "Right. Auth belongs at the transport layer. Credentials in tool inputs leak into model context and beyond."
            },
      ...
      "concepts": [
        {
          "id": "b5-1",
          "code": "B5.1",
          "title": "Place hook on correct event",
          "bloom": "A",
          "lesson": {
            "status": "ready",
            "paragraphs": [
            ...
            "questions": [
              ...
              },
              {
                ...
                "options": {
                  ...
                  "B": "Notification — picks up the harness's task-completed signal.",
                  "C": "Stop — fires once when the assistant signals task completion (per-turn granularity).",
                ...
                "explanations": {
                  ...
                  "B": "Notification is for transient harness messages, not the canonical per-task hook.",
                  "C": "Right. Stop fires once per task / turn. That matches the user's 'every time you finish a task' trigger directly.",
              ...
              },
              {
                ...
                "options": {
                  ...
                  "B": "PreCompact — runs around context compaction, which is when the model needs the orienting context most.",
                  "C": "PreToolUse — runs before any tool call, so it's the earliest moment available.",
                  "D": "SessionStart — fires once when the session begins; the harness can prepend the git info as initial context."
                },
                "correct": "D",
                "explanations": {
                  "A": "Works, but runs every turn — wasteful repetition. The trigger is 'at start of session,' not 'every turn.'",
                  "B": "PreCompact fires only around compaction events, not at session boot. Wrong moment.",
                  "C": "PreToolUse fires per individual tool call — wrong granularity for a one-shot setup.",
                  "D": "Right. SessionStart is the canonical 'prepare initial context' event. Fires once, attaches the git info, the rest of the session has it."
                },
        ...
        },
        {
          "id": "b5-2",
          "code": "B5.2",
          "title": "Predict permission cascade",
          "bloom": "An",
          "lesson": {
            "status": "ready",
            "paragraphs": [
            ...
            "questions": [
              {
                ...
                "options": {
                  ...
                  "B": "Ask — conflict triggers a prompt.",
                  "C": "Allowed — local project settings override shared project settings.",
                ...
                "explanations": {
                  ...
                  "B": "No prompt; the cascade resolves deterministically.",
                  "C": "Right. The cascade order is Enterprise > CLI > project-local > project-shared > user. Local project wins over shared project. This is the most-commonly-inverted gotcha.",
              ...
              },
              {
                ...
                "options": {
                  ...
                  "B": "Ask — conflict prompts the user.",
                  "C": "Allowed — `Bash(*)` is more specific than `Bash(rm -rf:*)`.",
                  "D": "Denied — Enterprise sits at the top of the cascade and locks the field; nothing lower can override."
                },
                "correct": "D",
                "explanations": {
                  "A": "Inverts the cascade.",
                  "B": "No prompt; the cascade is deterministic.",
                  "C": "`Bash(*)` is broader, not more specific. Specificity isn't the resolution rule; layer precedence is.",
                  "D": "Right. Enterprise > CLI > project-local > project-shared > user. Enterprise denies are sticky — that's the entire point of Enterprise managed settings."
                },
              ...
              },
              {
                ...
                "correct": "A",
                "explanations": {
                  "A": "Right. The canonical cascade order. Enterprise is highest; user is lowest. Local-project is above shared-project (the most common gotcha).",
                  "B": "Inverts everything.",
        ...
        },
        {
          "id": "b5-3",
          "code": "B5.3",
          "title": "Route rule (CLAUDE.md / reference / skill / slash / hook)",
          "bloom": "E",
          "lesson": {
            "status": "ready",
            "paragraphs": [
            ...
            "questions": [
              {
                ...
                "options": {
                  ...
                  "C": "Create a slash command that runs lint, and tell the user to invoke it after each task.",
                  "D": "Configure a Stop hook in settings.json that runs `npm run lint` and prints the result."
                },
                "correct": "D",
                "explanations": {
                  ...
                  "C": "Slash commands require user invocation; 'every time' = harness.",
                  "D": "Right. Hooks run in the harness layer, deterministically. 'Every time you finish a task' = per-turn = Stop hook (PostToolUse would fire per-tool-call)."
                },
              ...
              },
              {
                ...
                "options": {
                  "A": "CLAUDE.md, since it's loaded into project context every session as advisory guidance the model interprets.",
                  "B": "A Stop hook that re-formats outputs after each task.",
                ...
                "correct": "A",
                "explanations": {
                  "A": "Right. Always-on advisory guidance is exactly CLAUDE.md's role. Loaded every session; the model reads and interprets.",
                  "B": "Hook for style-nudging is over-engineered; a hook can't 'nudge', only enforce or transform.",
              ...
              },
              {
                ...
                "options": {
                  ...
                  "B": "A slash command (e.g., `/rebuild-and-test`) that expands into the full prompt sequence; checked into the project.",
                  "C": "Add a paragraph to CLAUDE.md describing how to do it.",
                  "D": "A Skill the user invokes from the menu."
                },
                "correct": "B",
                "explanations": {
                  "A": "Hook is heavy machinery for what's just a reusable prompt.",
                  "B": "Right. Reusable on-demand prompt expansion = slash command. Project-scoped (checked in) = team can use it.",
                  "C": "Forces the user to remember the steps every time.",
            ...
            "questions": [
              {
                ...
                "options": {
                  "A": "`.claude/commands/<name>.md` inside the repo, checked into version control.",
                  "B": "`~/.claude/commands/<name>.md` — under the user's home directory.",
                  "C": "`.vscode/commands/<name>.md` — picked up by the editor extension.",
                  "D": "`docs/commands/<name>.md` — referenced from CLAUDE.md."
                },
                "correct": "A",
                "explanations": {
                  "A": "Right. `.claude/commands/` inside the project, checked in, ships with clones, available team-wide.",
                  "B": "Personal commands location; not shipped with the repo.",
                  "C": "Fabricated path.",
              ...
              },
              {
                ...
                "options": {
                  ...
                  "B": "When the workflow needs to run on a hook event.",
                  "C": "When the workflow needs bundled assets, supporting files, or richer menu discoverability beyond a prompt expansion.",
                ...
                "explanations": {
                  ...
                  "B": "Hooks are for harness-event automation, distinct from both.",
                  "C": "Right. Skills are prompt + supporting files + menu metadata. Slash commands are prompt-only. Reach for Skill when you need more than just the prompt.",
        ...
        "questions": [
          ...
          },
          {
            ...
            "options": {
              ...
              "B": "(a) PostToolUse hook; (b) PreToolUse hook.",
              "C": "(a) PreToolUse hook (only event with a block primitive); (b) Stop hook (per-task granularity).",
              "D": "(a) Slash command; (b) Skill."
            },
            "correct": "C",
            "explanations": {
              "A": "Both are advisory; neither is enforced.",
              "B": "PostToolUse can't block; PreToolUse fires on every tool call (lint floods).",
              "C": "Right. Hard rule needing block before execution = PreToolUse. Per-task automation = Stop. Granularity matters: PostToolUse fires per-tool-call (lint floods).",
          ...
          },
          {
            ...
            "options": {
              ...
              "B": "A slash command the user types before each prompt.",
              "C": "A Stop hook that re-formats outputs.",
              "D": "CLAUDE.md — loaded into project context every session as advisory guidance."
            },
            "correct": "D",
            "explanations": {
              "A": "Skills are user-invoked; the rule wouldn't apply silently if forgotten.",
              "B": "Relies on user remembering to invoke.",
              "C": "Re-formatting outputs ≠ nudging the model toward patterns at generation time.",
              "D": "Right. Always-on advisory guidance is exactly CLAUDE.md's role. Loaded every session; the model reads and interprets."
            },
            "principle": "Always-on advice = CLAUDE.md. Skills and slash commands are user-invoked; hooks are enforcement.",
            "bSkills": [
              "B5.3"
          ...
          },
          {
            ...
            "options": {
              "A": "Project: `.claude/commands/<name>.md`. Personal: `~/.claude/commands/<name>.md`.",
              "B": "Both in `~/.claude/commands/`.",
              "C": "Project: `docs/slash/`. Personal: `~/.config/claude/`.",
              "D": "Both in `.vscode/commands/`."
            },
            "correct": "A",
            "explanations": {
              "A": "Right. `.claude/commands/` (project, checked in) for team-shared; `~/.claude/commands/` for personal.",
              "B": "Personal-only doesn't ship with the repo.",
              "C": "Fabricated paths.",
      ...
      "concepts": [
        {
          "id": "b6-1",
          "code": "B6.1",
          "title": "Order all hook lifecycle events",
          "bloom": "R",
          "lesson": {
            "status": "ready",
            "paragraphs": [
            ...
            "questions": [
              {
                ...
                "options": {
                  ...
                  "B": "Stop → UserPromptSubmit → PreToolUse → PostToolUse.",
                  "C": "UserPromptSubmit → PreToolUse(1) → tool → PostToolUse(1) → PreToolUse(2) → tool → PostToolUse(2) → Stop.",
                  "D": "PreToolUse → UserPromptSubmit → tool → PostToolUse → Stop."
                },
                "correct": "C",
                "explanations": {
                  "A": "Pre/PostToolUse fire per individual tool call, not per turn.",
                  "B": "Stop fires at task end, not before UserPromptSubmit.",
                  "C": "Right. The harness fires Pre/PostToolUse once per call. Two tool calls in a turn = two Pre + two Post.",
              ...
              },
              {
                ...
                "explanations": {
                  ...
                  "B": "Per task/turn.",
                  "C": "Per user turn.",
                  "D": "Right. SessionStart (and SessionEnd) fire once per session boundary."
                },
              ...
              },
              {
                ...
                "options": {
                  "A": "SubagentStop — distinct from the parent's own Stop event.",
                  "B": "Stop — same as a normal task end.",
                ...
                "correct": "A",
                "explanations": {
                  "A": "Right. SubagentStop is the dedicated event for subagent completion in the parent's lifecycle.",
                  "B": "Stop is the parent's own task end, not the subagent's.",
        ...
        },
        {
          "id": "b6-2",
          "code": "B6.2",
          "title": "Hook vs CLAUDE.md by trust level",
          "bloom": "E",
          "lesson": {
            "status": "ready",
            "paragraphs": [
            ...
            "questions": [
              {
                ...
                "explanations": {
                  ...
                  "B": "GitHub protection is good defense-in-depth but doesn't substitute for the harness-side rule when the model has push access.",
                  "C": "Doesn't address the trust-layer mismatch.",
                  "D": "Right. Trust requirement is high (production main branch). CLAUDE.md is advisory; only hooks enforce. A PreToolUse hook makes the rule unbypassable from the model side."
                },
              ...
              },
              {
                ...
                "correct": "A",
                "explanations": {
                  "A": "Right. Trust requirement is low for style. CLAUDE.md is the right layer; reserve hooks for cases where override is unacceptable.",
                  "B": "PreToolUse hooks can read tool input; that's not the issue.",
              ...
              },
              {
                ...
                "options": {
                  ...
                  "B": "'Refuse to execute any shell command containing `--no-verify`, regardless of permission mode.'",
                  "C": "'Always include a docstring on public functions.'",
                  "D": "'Use UK English spelling in user-facing strings.'"
                },
                "correct": "B",
                "explanations": {
                  "A": "Style preference; CLAUDE.md.",
                  "B": "Right. Bypassing a verify gate has real consequences. The model cannot be allowed to override it; only a PreToolUse hook can guarantee enforcement.",
                  "C": "Style preference; CLAUDE.md.",
        ...
        },
        {
          "id": "b6-3",
          "code": "B6.3",
          "title": "Predict no-watermark loop failure",
          "bloom": "An",
          "lesson": {
            "status": "ready",
            "paragraphs": [
            ...
            "questions": [
              {
                ...
                "options": {
                  "A": "Add a soft watermark at ~80% of context fill: finish current unit, commit, exit cleanly, resume next run. Add a hard watermark at ~95% as a safety net.",
                  "B": "Increase max_tokens so the agent has more room to think.",
                ...
                "correct": "A",
                "explanations": {
                  "A": "Right. Self-pacing watermarks (~80% commit + exit cleanly, ~95% hard exit) are the canonical defense against runaway loops. Partial progress is preserved; the next run resumes.",
                  "B": "Confuses turn budget with token budget. max_tokens controls per-message generation, not loop count.",
              ...
              },
              {
                ...
                "options": {
                  ...
                  "B": "In CLAUDE.md as a hard rule.",
                  "C": "At the harness / loop layer that monitors token usage and triggers commit/exit; the model itself doesn't reliably track its own context usage.",
                ...
                "explanations": {
                  ...
                  "B": "Advisory; not enforcement.",
                  "C": "Right. Watermark is operational state monitored by the harness; the harness initiates the clean exit. The model executes the commit-and-exit but doesn't decide when.",
            ...
            "questions": [
              ...
              },
              {
                ...
                "options": {
                  ...
                  "B": "Each subagent invocation is its own model invocation chain (costs tokens).",
                  "C": "The parent receives the subagent's final summary, not its full tool-call trail.",
                  "D": "Subagents have access to a strictly larger context window than their parent."
                },
                "correct": "D",
                "explanations": {
                  "A": "True — subagents must be self-contained-briefed.",
                  "B": "True — cost discipline matters.",
                  "C": "True — context isolation is unidirectional.",
                  "D": "Right (false statement). Subagents have a fresh window of the *same size* as the parent's. The window-size distractor is common on the exam."
                },
            ...
            "questions": [
              {
                ...
                "options": {
                  ...
                  "B": "GitHub blocks Claude Code from running in Actions by default.",
                  "C": "The CI step runs unattended (no developer to interrupt) AND has access to repo secrets, registry tokens, and protected-branch permissions — autonomy × privilege = blast radius is higher.",
                  "D": "CI runs on a different model that ignores hooks."
                },
                "correct": "C",
                "explanations": {
                  "A": "Operational concern; not the structural risk.",
                  "B": "Not true; Actions can run Claude Code.",
                  "C": "Right. CI's autonomy combined with its access to secrets and protected resources raises the ceiling on damage. Local dev has the dev as a brake; CI has none.",
              ...
              },
              {
                ...
                "options": {
                  ...
                  "B": "Use the same admin token for CI as developers use locally.",
                  "C": "Increase the workflow's timeout so it can't be interrupted mid-task.",
                  "D": "Scope the workflow's GitHub token to least-privilege (read-only on protected branches), and add PreToolUse hooks denying `git push.*protected`, `npm publish`, and similar side-effecting operations."
                },
                "correct": "D",
                "explanations": {
                  "A": "More runs = more chances for bad outcomes; not a mitigation.",
                  "B": "Anti-pattern; admin tokens in CI are the worst case.",
                  "C": "Increasing timeouts widens the damage window.",
                  "D": "Right. Two complementary controls: token scoping (reduce what's reachable) + PreToolUse hooks (refuse dangerous operations on the operations that are reachable). Layered."
                },
              ...
              },
              {
                ...
                "options": {
                  "A": "False — env-var secrets are accessible to any shell-capable process in the step, including Claude Code.",
                  "B": "True — Claude Code is sandboxed away from process env vars in CI.",
                  "C": "True — secrets are encrypted and only the GitHub runner can read them.",
                  "D": "Depends on the secret's classification level."
                },
                "correct": "A",
                "explanations": {
                  "A": "Right. Env-var secrets are accessible to any shell-capable process. Mitigation is to inject only the secrets the step actually needs and to gate side-effecting operations.",
                  "B": "Fabricated sandbox.",
                  "C": "Once injected into the step's env, they're plain env vars to the process.",
                  "D": "Fabricated tier."
                },
        ...
        "questions": [
          {
            ...
            "options": {
              ...
              "B": "PreToolUse → UserPromptSubmit → tool → PostToolUse → Stop.",
              "C": "UserPromptSubmit → PreToolUse → PostToolUse → Stop. (Pre/Post fire once per turn.)",
              "D": "UserPromptSubmit → PreToolUse(1) → PostToolUse(1) → PreToolUse(2) → PostToolUse(2) → Stop."
            },
            "correct": "D",
            "explanations": {
              "A": "Stop is at the end of the turn, not the start.",
              "B": "UserPromptSubmit fires before tool calls, not interleaved.",
              "C": "Pre/Post fire per call, not per turn.",
              "D": "Right. Pre/PostToolUse fire per individual tool call. Stop fires once per task."
            },
          ...
          },
          {
            ...
            "options": {
              "A": "Move the rule to a PreToolUse hook that pattern-matches `git push.*main` and refuses; CLAUDE.md is advisory, hooks are enforced.",
              "B": "Reword the CLAUDE.md sentence in stronger language.",
              "C": "Switch to a more capable model.",
              "D": "Disable CLAUDE.md and rely on GitHub branch protection alone."
            },
            "correct": "A",
            "explanations": {
              "A": "Right. High trust requirement (production main) demands enforcement, not advice. PreToolUse + deny is the canonical fix.",
              "B": "Stronger wording doesn't change the trust layer.",
              "C": "Doesn't address the trust-layer mismatch.",
          ...
          },
          {
            ...
            "options": {
              ...
              "B": "Use the same admin token developers use locally so CI behaves consistently.",
              "C": "Scope the workflow's GitHub token to least-privilege AND add PreToolUse hooks denying side-effecting operations like `git push.*protected` and `npm publish` — CI's autonomy raises the damage ceiling.",
            ...
            "explanations": {
              ...
              "B": "Anti-pattern. Admin tokens in CI are the worst case.",
              "C": "Right. Scope the token (reduce what's reachable) + hook the side-effecting operations (refuse dangerous ones). Defence in depth.",
      ...
      "concepts": [
        {
          "id": "b7-1",
          "code": "B7.1",
          "title": "Skill vs slash vs CLAUDE.md vs hook (by invocation model)",
          "bloom": "An",
          "lesson": {
            "status": "ready",
            "paragraphs": [
            ...
            "questions": [
              {
                ...
                "options": {
                  "A": "CLAUDE.md, which is auto-loaded into project context every session.",
                  "B": "A Skill called `project-rules` users invoke at session start.",
                  "C": "A slash command users type before each prompt.",
                  "D": "A SubagentStop hook."
                },
                "correct": "A",
                "explanations": {
                  "A": "Right. CLAUDE.md is the only of these that auto-loads every session.",
                  "B": "Skills are user-invoked, not auto-loaded. Rule silently fails when the user forgets.",
              ...
              },
              {
                ...
                "explanations": {
                  ...
                  "B": "Right. PreToolUse is the only event with a block primitive. Hooks run in the harness regardless of model decision.",
                  "C": "User-invoked instruction bundle; no enforcement layer.",
                  "D": "User-invoked prompt expansion; no enforcement layer."
                },
              ...
              },
              {
                ...
                "options": {
                  ...
                  "B": "PostCompact hook — hooks can carry arbitrary payloads.",
                  "C": "Skill — Skills bundle instructions plus optional assets and surface in a menu.",
                  "D": "CLAUDE.md — large bundles can live in CLAUDE.md."
                },
                "correct": "C",
                "explanations": {
                  "A": "Slash commands are prompt-only.",
                  "B": "Hooks fire on events; not for user-invoked bundles.",
                  "C": "Right. Skills are the canonical mechanism for user-invoked work that bundles instructions with supporting files.",
        ...
        },
        {
          "id": "b7-2",
          "code": "B7.2",
          "title": "Critique skill description for discoverability",
          "bloom": "E",
          "lesson": {
            "status": "ready",
            "paragraphs": [
          ...
          "quiz": {
            "questions": [
              ...
              },
              {
                ...
                "options": {
                  "A": "Run a spell-check.",
                  "B": "Check it loads without error.",
                  "C": "Count the words; under 30 is best.",
                  "D": "Read it side-by-side with neighbouring Skills' descriptions; the boundaries should be obvious to a new user."
                },
                "correct": "D",
                "explanations": {
                  "A": "Spelling is hygiene; not the discoverability test.",
                  "B": "Loading without error doesn't measure discoverability.",
                  "C": "Length isn't the criterion; differentiation is.",
                  "D": "Right. Skills compete for selection. The discoverability test is comparative: can a user pick the right one from the menu without already knowing the answer?"
                },
        ...
        },
        {
          "id": "b7-3",
          "code": "B7.3",
          "title": "Place skill (project / user / plugin)",
          "bloom": "A",
          "lesson": {
            "status": "ready",
            "paragraphs": [
            ...
            "questions": [
              {
                ...
                "options": {
                  ...
                  "B": "Distributed via a plugin marketplace install.",
                  "C": "`.claude/skills/<name>/` checked into the project repo.",
                  "D": "In CLAUDE.md as a referenced section."
                },
                "correct": "C",
                "explanations": {
                  "A": "Personal location; doesn't ship with the repo.",
                  "B": "Plugin distribution is for cross-project skills, not project-shared ones.",
                  "C": "Right. `.claude/skills/` inside the project, checked in, ships with clones.",
              ...
              },
              {
                ...
                "options": {
                  ...
                  "B": "In CLAUDE.md of the project they happen to be in.",
                  "C": "Published as a plugin so they can install it on each machine.",
                  "D": "In `~/.claude/skills/<name>/` in their home directory."
                },
                "correct": "D",
                "explanations": {
                  "A": "Cluttering every project with personal skills is the inverse antipattern.",
                  "B": "Project CLAUDE.md is project-scoped and not for personal skills.",
                  "C": "Plugin is heavy machinery for a single-user case.",
                  "D": "Right. `~/.claude/skills/` is the personal-skills location; available across all projects without polluting any."
                },
              ...
              },
              {
                ...
                "options": {
                  "A": "When many teams or external users need the skill, with versioned independent distribution and updates.",
                  "B": "When a single user needs the skill across all their projects.",
                  "C": "When only one team needs the skill in a single repo.",
                  "D": "Never — plugins are deprecated."
                },
                "correct": "A",
                "explanations": {
                  "A": "Right. Plugin/marketplace is for skills with cross-project, cross-team distribution and independent versioning.",
                  "B": "Single-user, multi-project is personal, not plugin.",
                  "C": "Single-team, single-repo is project-shared, not plugin.",
                  "D": "Not deprecated."
                },
        ...
        },
        {
          "id": "b7-4",
          "code": "B7.4",
          "title": "Detect kitchen-sink skill",
          "bloom": "An",
          "lesson": {
            "status": "ready",
            "paragraphs": [
            ...
            "questions": [
              {
                ...
                "options": {
                  ...
                  "B": "Skills should have at least four purposes for sufficient utility.",
                  "C": "The Skill needs a longer description to fully explain each capability.",
                  "D": "Kitchen-sink skill — four unrelated purposes bundled together. Split into focused Skills (one per purpose) so each has a clean description and the model gets a focused brief."
                },
                "correct": "D",
                "explanations": {
                  "A": "Lifecycle coverage is exactly the kitchen-sink trap.",
                  "B": "Fabricated guideline.",
                  "C": "Longer descriptions don't fix multi-purpose bundling.",
                  "D": "Right. Multi-purpose Skills suffer from instruction drift, vague descriptions, and reuse failures. Split into focused Skills."
                },
              ...
              },
              {
                ...
                "options": {
                  "A": "Kitchen-sink Skill — partial instruction adherence is the predictable symptom of multi-purpose bundles. Split into focused Skills.",
                  "B": "The model needs to be more capable.",
                  "C": "The description needs to emphasise the explain-code half more.",
                  "D": "The user needs to invoke the Skill twice."
                },
                "correct": "A",
                "explanations": {
                  "A": "Right. Partial adherence is the canonical symptom of a Skill trying to do too much. The model partially follows; users see inconsistent results across the goals. Splitting fixes the cause.",
                  "B": "Doesn't address the structural cause.",
        ...
        "questions": [
          {
            ...
            "options": {
              "A": "Skills are user-invoked, not auto-loaded — the rule applies only when the Skill is invoked. For an always-on rule, move it to CLAUDE.md (advisory) or a hook (enforced).",
              "B": "The Skill needs a higher priority field in its frontmatter.",
              "C": "Vue 3 isn't supported by the model.",
              "D": "Skills can't carry style preferences."
            },
            "correct": "A",
            "explanations": {
              "A": "Right. Skills are user-invoked. Always-on rules belong in CLAUDE.md (advisory) or a hook (enforced).",
              "B": "Fabricated priority field; doesn't address the invocation model.",
              "C": "Off-axis.",
          ...
          },
          {
            ...
            "options": {
              ...
              "B": "Move the Skill to CLAUDE.md.",
              "C": "Split the kitchen-sink Skill into three focused Skills: `release-notes`, `deploy`, `explain-code`. Each gets a focused description and a focused brief.",
              "D": "Add more examples to the Skill body."
            },
            "correct": "C",
            "explanations": {
              "A": "Distribution channel doesn't fix the bundling problem.",
              "B": "Skills aren't replaced by CLAUDE.md; they have different invocation models.",
              "C": "Right. Kitchen-sink Skills cause partial adherence, vague descriptions, and reuse failures. Splitting is the canonical fix.",
          ...
          },
          {
            ...
            "options": {
              ...
              "B": "CLAUDE.md as a referenced section.",
              "C": "A plugin marketplace install required for each developer.",
              "D": "`.claude/skills/<name>/` checked into the repo."
            },
            "correct": "D",
            "explanations": {
              "A": "Personal location; doesn't ship with the repo.",
              "B": "Not a Skill-distribution mechanism.",
              "C": "Plugin distribution is for cross-project; team-shared is project location.",
              "D": "Right. `.claude/skills/` inside the project, checked in, ships with clones."
            },
            "principle": "Project-shared Skills live in `.claude/skills/` checked into the repo. Audience = the project's contributors.",
            "bSkills": [
              "B7.3"
      ...
      "concepts": [
        {
          "id": "b8-1",
          "code": "B8.1",
          "title": "Two valid spawn triggers",
          "bloom": "R",
          "lesson": {
            "status": "ready",
            "paragraphs": [
            ...
            "questions": [
              ...
              },
              {
                ...
                "explanations": {
                  ...
                  "B": "Forcing parallelism on dependent steps doesn't work.",
                  "C": "Right. Strictly sequential work doesn't fit either trigger. Spawning costs tokens for no benefit.",
              ...
              },
              {
                ...
                "options": {
                  ...
                  "C": "Subagents can access the parent's tool-call trail in real time.",
                  "D": "Each subagent starts with a fresh context window of the *same* size as the parent's."
                },
                "correct": "D",
                "explanations": {
                  "A": "False — fresh, not bigger.",
                  "B": "False — subagents start fresh; brief them explicitly.",
                  "C": "False — context isolation is unidirectional; the subagent doesn't see the parent's trail.",
                  "D": "Right. Fresh, same-size window. The exam-tested fact."
                },
        ...
        },
        {
          "id": "b8-2",
          "code": "B8.2",
          "title": "Critique underbriefed subagent prompt",
          "bloom": "E",
          "lesson": {
            "status": "ready",
            "paragraphs": [
            ...
            "questions": [
              {
                ...
                "options": {
                  ...
                  "B": "Subagent will return an error indicating insufficient context.",
                  "C": "Subagent will produce plausible-sounding but unrelated work because it has no access to the parent's conversation; the brief left all the relevant context implicit.",
                ...
                "explanations": {
                  ...
                  "B": "Subagents don't error on vague briefs; they generate something.",
                  "C": "Right. Subagents have no parent-conversation memory. 'Based on the discussion above' references context the subagent literally cannot see.",
              ...
              },
              {
                ...
                "options": {
                  ...
                  "C": "'Goal: implement parseInvoiceLine per docs/invoice_format.md.'",
                  "D": "'Continue from where we left off, applying our usual patterns.'"
                },
                "correct": "D",
                "explanations": {
                  "A": "Names the output shape — good.",
                  "B": "Names constraints — good.",
                  "C": "Goal + reference to a concrete spec — good.",
                  "D": "Right. References both implicit conversation history ('where we left off') and implicit team norms ('our usual patterns'). Subagent can't see either."
                },
              ...
              },
              {
                ...
                "options": {
                  "A": "An estimate of the parent's remaining token budget.",
                  "B": "The relevant context the subagent needs (paths, decisions, constraints).",
                  "C": "The goal in one sentence.",
                  "D": "The expected output shape (summary, diff, JSON record)."
                },
                "correct": "A",
                "explanations": {
                  "A": "Right. Token-budget estimates are not part of a subagent brief; they're parent-side operational concerns.",
                  "B": "Required.",
                  "C": "Required.",
                  "D": "Required."
                },
        ...
        },
        {
          "id": "b8-3",
          "code": "B8.3",
          "title": "Cost of unnecessary subagent splits",
          "bloom": "An",
          "lesson": {
            "status": "ready",
            "paragraphs": [
            ...
            "questions": [
              {
                ...
                "options": {
                  ...
                  "B": "Cheaper because each subagent uses a smaller model automatically.",
                  "C": "Same cost as inline; subagents are free.",
                  "D": "Roughly 3× the tokens of inline (setup + round-trip + integration overhead per subagent), with no parallelism or isolation win — pure waste."
                },
                "correct": "D",
                "explanations": {
                  "A": "Subagents pay setup overhead each; they're not smaller.",
                  "B": "Subagents inherit the parent model unless explicitly configured.",
                  "C": "Subagents cost real tokens.",
                  "D": "Right. Three subagents = 3× setup, 3× round-trip, plus the parent's integration cost. Sequential dependent work fits neither trigger; the cost is pure waste."
                },
              ...
              },
              {
                ...
                "options": {
                  "A": "A separate API key per subagent.",
                  "B": "Round-trip tokens for the subagent's own tool-use loop.",
                  "C": "Setup tokens (system prompt, tool definitions, brief).",
                  "D": "Integration tokens in the parent (reading and incorporating the summary)."
                },
                "correct": "A",
                "explanations": {
                  "A": "Right. There's no per-subagent API-key requirement; subagents share the parent's authentication. Distractor.",
                  "B": "Real cost.",
                  "C": "Real cost.",
                  "D": "Real cost."
                },
              ...
              },
              {
                ...
                "options": {
                  "A": "Each subagent has its own system prompt.",
                  "B": "The parent waits for each subagent to finish before briefing the next (serialised dispatch).",
                  "C": "Subagents return summaries instead of tool-call trails.",
                  "D": "Subagents have a fresh context window."
                },
                "correct": "B",
                "explanations": {
                  "A": "Normal subagent property.",
                  "B": "Right. Serialised dispatch means parallelism is not being used — the only remaining trigger would be isolation, and trivially-sequential work usually doesn't need isolation either. Pay the cost; get nothing.",
        ...
        },
        {
          "id": "b8-4",
          "code": "B8.4",
          "title": "What parent does NOT see from subagent",
          "bloom": "U",
          "lesson": {
            "status": "ready",
            "paragraphs": [
            ...
            "questions": [
              {
                ...
                "options": {
                  "A": "Whatever the subagent chose to include in its summary; if it didn't mention the ruled-out hypotheses, the parent can't see them.",
                  "B": "The full tool-call trail of the subagent's investigation.",
                ...
                "correct": "A",
                "explanations": {
                  "A": "Right. Parent sees only the summary. If the parent needs the ruled-out hypotheses, the brief must request them as part of the summary shape.",
                  "B": "Parent doesn't see the trail.",
              ...
              },
              {
                ...
                "options": {
                  ...
                  "B": "Configure the harness to forward all subagent tool calls to the parent.",
                  "C": "Specify in the brief the exact shape of the summary the subagent should return — including, for risky work, intermediate notes the parent might need to debug.",
                ...
                "explanations": {
                  ...
                  "B": "Not a feature; context isolation is the point of subagents.",
                  "C": "Right. Specify the summary shape upfront. For risky work, request intermediate notes (assumptions, hypotheses tried, failures encountered) so the parent has enough to debug.",
        ...
        "questions": [
          ...
          },
          {
            ...
            "options": {
              ...
              "B": "The subagent will request the missing context automatically.",
              "C": "Underbriefed — references implicit conversation history ('where we left off') and implicit team norms ('our usual patterns') that the subagent cannot see. Rewrite to be self-contained: goal, context, constraints, expected output.",
              "D": "The subagent will inherit the parent's conversation."
            },
            "correct": "C",
            "explanations": {
              "A": "Length is the symptom; structure is the cause.",
              "B": "Subagents don't request missing context.",
              "C": "Right. The two smell phrases ('where we left off', 'usual patterns') reference parent-only context. Subagent has no access. Brief must be self-contained.",
              "D": "Context isolation is unidirectional — no inheritance."
            },
          ...
          },
          {
            ...
            "options": {
              ...
              "B": "Cost is identical to inline.",
              "C": "Each subagent runs on a cheaper model; cost is roughly 1/3.",
              "D": "~3× the tokens of inline (setup + round-trip + integration overhead) with no parallelism or isolation win — pure waste. Inline the work in the parent."
            },
            "correct": "D",
            "explanations": {
              "A": "Subagents cost real tokens.",
              "B": "Inline doesn't pay setup-per-subagent overhead.",
              "C": "Subagents inherit the parent model.",
              "D": "Right. Per-subagent setup + round-trip + integration overhead, multiplied by 3, with no offsetting trigger. Sequential dependent work belongs in the parent loop."
            },
          ...
          },
          {
            ...
            "options": {
              "A": "Sees only what the subagent's summary contains. Fix: the brief must specify the summary shape, asking explicitly for the file list and assumptions.",
              "B": "Sees the full tool-call trail by default; no fix needed.",
              "C": "Sees the subagent's intermediate context up to a 1KB cap.",
              "D": "Sees nothing; subagent invocations are fire-and-forget."
            },
            "correct": "A",
            "explanations": {
              "A": "Right. Context isolation is unidirectional. The parent sees only the summary; specify the summary shape in the brief.",
              "B": "Trail isn't visible to parent.",
    ...
    },
    {
      ...
      "concepts": [
            ...
            "questions": [
              {
                ...
                "options": {
                  ...
                  "B": "Skills need to be in a specific directory.",
                  "C": "Capability is missing — Slack messaging requires a Slack *plugin* (which provides the tool). A skill can only steer existing capabilities; it can't introduce new ones.",
                  "D": "Slack notifications are not supported by Cowork."
                },
                "correct": "C",
                "explanations": {
                  "A": "Fabricated priority field; doesn't address the layer error.",
                  "B": "Location isn't the structural issue.",
                  "C": "Right. Plugins introduce capabilities; skills steer existing ones. A skill instructing 'use the Slack tool' fails when the Slack tool doesn't exist — because no plugin provides it.",
              ...
              },
              {
                ...
                "options": {
                  ...
                  "B": "Plugins are deprecated in favour of skills.",
                  "C": "Plugin = instructions; skill = capability (inverse of B).",
                  "D": "Plugin = capability (introduces tools / abilities); skill = instructions (steers how existing capabilities are used)."
                },
                "correct": "D",
                "explanations": {
                  "A": "They're complementary, not synonymous.",
                  "B": "Both are first-class extensions in Cowork.",
                  "C": "Inverted.",
                  "D": "Right. Plugins add abilities; skills add steering. Most tasks use both."
                },
        ...
        },
        {
          "id": "b9-2",
          "code": "B9.2",
          "title": "Add appropriate human-checkpoint cadence",
          "bloom": "E",
          "lesson": {
            "status": "ready",
            "paragraphs": [
            ...
            "questions": [
              {
                ...
                "options": {
                  ...
                  "B": "The agent should self-monitor and self-correct without human intervention.",
                  "C": "Tasks should be split into 5 separate 1-day tasks.",
                  "D": "Drift accumulates over 5 days; one end-of-task review can't catch it. Add a daily checkpoint cadence so the human can correct course while drift is small."
                },
                "correct": "D",
                "explanations": {
                  "A": "5-day tasks are supported.",
                  "B": "Self-monitoring is unreliable; cadence is the structural mitigation.",
                  "C": "Splitting may help structurally but doesn't substitute for cadence.",
                  "D": "Right. Cowork is collaborative-by-design; long tasks without checkpoint cadence drift silently. Daily cadence is the fix for multi-day work."
                },
              ...
              },
              {
                ...
                "options": {
                  "A": "A concrete artefact (partial output, written plan, code-in-progress) plus a list of assumptions and open questions, surfaced at the cadence.",
                  "B": "A 'continuing as planned' message every hour.",
                  "C": "A sentiment score summarising agent confidence.",
                  "D": "A token-usage report at end-of-day."
                },
                "correct": "A",
                "explanations": {
                  "A": "Right. Concrete artefacts + assumptions + open questions give the human enough to inspect and correct. Drift hides in unstated assumptions.",
                  "B": "Abstract; doesn't let the human see drift concretely.",
        ...
        },
        {
          "id": "b9-3",
          "code": "B9.3",
          "title": "Detect set-and-forget antipattern",
          "bloom": "An",
          "lesson": {
            "status": "ready",
            "paragraphs": [
            ...
            "questions": [
              {
                ...
                "correct": "A",
                "explanations": {
                  "A": "Right. 'Autonomous' framing for Cowork is the antipattern. Drift over a week without review is almost guaranteed.",
                  "B": "Week-long tasks are supported.",
              ...
              },
              {
                ...
                "options": {
                  "A": "Single-hour task + one final review.",
                  "B": "Multi-day task + zero mid-task interaction + no intermediate artefacts emitted.",
                  "C": "Multi-day task + daily checkpoints with concrete artefacts.",
                  "D": "Multi-week task + daily and weekly checkpoints."
                },
                "correct": "B",
                "explanations": {
                  "A": "Short task; one final review is plausibly OK.",
                  "B": "Right. Multi-day duration + no interaction + no artefacts = the canonical antipattern.",
              ...
              },
              {
                ...
                "options": {
                  ...
                  "B": "Daily cadence is too frequent; reduce to weekly.",
                  "C": "Empty cadence — checkpoints exist but provide no concrete artefacts to inspect, so drift is invisible. Fix: emit intermediate artefacts (partial output, plans, code snapshots) the human can review.",
                  "D": "The agent should use a different model."
                },
                "correct": "C",
                "explanations": {
                  "A": "False confidence; abstract checkpoints can't catch drift.",
                  "B": "Frequency isn't the issue.",
                  "C": "Right. Cadence is the *opportunity* for review; without artefacts, there's nothing to review. The structural fix is artefact emission shape.",
        ...
        "questions": [
          ...
          },
          {
            ...
            "explanations": {
              ...
              "B": "Splitting may help but isn't a substitute for cadence.",
              "C": "Right. Multi-day cadence = daily. Cowork is set-and-steer; cadence is the structural antidote to drift.",
          ...
          },
          {
            ...
            "options": {
              ...
              "B": "Single-hour task with no checkpoints.",
              "C": "Multi-week task with daily and weekly checkpoints.",
              "D": "Multi-day task with no mid-task interaction and no intermediate artefacts emitted; operator describes it as 'autonomous'."
            },
            "correct": "D",
            "explanations": {
              "A": "Reasonable cadence for a short task.",
              "B": "Short and probably fine.",
              "C": "Correct cadence shape for multi-week strategic work.",
              "D": "Right. The full antipattern signature: long duration + zero interaction + no artefacts + 'autonomous' framing. Cowork is collaborative; this isn't."
            },
          ...
          },
          {
            ...
            "options": {
              "A": "Empty cadence — review opportunity exists but there's nothing concrete to inspect. Fix: emit intermediate artefacts (partial output, plans, code snapshots) at each checkpoint so the human can see drift, not just hear about it.",
              "B": "Cadence is too frequent; reduce to weekly.",
              "C": "The agent's confidence score is too high.",
              "D": "The team should trust the agent and remove the cadence."
            },
            "correct": "A",
            "explanations": {
              "A": "Right. Cadence + artefacts is the design. Cadence without artefacts is false confidence.",
              "B": "Frequency isn't the issue.",
