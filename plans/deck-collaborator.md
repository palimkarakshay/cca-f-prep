...
falsification triggers, full bibliography). Independent critical-review
framework: [`expert-review-audit.md`](./expert-review-audit.md) — 68+
pre-populated audit rows for psychology / learning / business-partner
reviewer roles; per-row score + recommendation; operator commits to
acting on every "abandon-claim" within 30 days.
